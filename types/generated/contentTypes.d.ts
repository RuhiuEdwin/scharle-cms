...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mission: Schema.Attribute.Component<'shared.rich-text-block', false>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vision: Schema.Attribute.Component<'shared.rich-text-block', false>;
    whoWeAre: Schema.Attribute.Component<'shared.image-text-block', false>;
  };
}
...
export interface ApiAdmissionsPageAdmissionsPage
  ...
  attributes: {
    activeIntakeMonths: Schema.Attribute.Enumeration<
      ['January', 'May', 'September']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    howToJoinSteps: Schema.Attribute.Component<'shared.step', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    registrationFeeNote: Schema.Attribute.String;
    requirementsChecklist: Schema.Attribute.Component<
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    careerOutcomes: Schema.Attribute.Component<'shared.list-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatYoullLearn: Schema.Attribute.Component<'shared.list-item', true>;
  };
}
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    showOnAbout: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Scharle Beauty College'>;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    socialLinks: Schema.Attribute.Component<'shared.social-link', true>;
    tagline: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Learn It. Live It. Glow It.'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStudentLifeHighlightStudentLifeHighlight
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::student-life-highlight.student-life-highlight'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiWhyScharleHighlightWhyScharleHighlight
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::why-scharle-highlight.why-scharle-highlight'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
